...
urlpatterns = [
    ...
    path('medical-form/', views.camper_medical_form, name="camper_medical_form"),
    path('medical-form-submitted', views.camper_medical_form_submitted, name="camper_medical_form_submitted"),
]
