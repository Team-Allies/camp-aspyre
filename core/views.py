...
def camper_medical_form(request):
  ...
  if request.method == 'POST':
    ...
    if form.is_valid():
      ...
      first_guardian_name = form_data.get("first_guardian_name")
      first_guardian_phone_number = form_data.get("first_guardian_phone_number")
      first_guardian_home_work_or_cell = form_data.get("first_guardian_home_work_or_cell")
      ...
      can_camper_be_picked_up_by_guardian_or_emergency_contact = form_data.get("can_camper_be_picked_up_by_guardian_or_emergency_contact")
      any_unauthorized_persons_that_can_pick_up_camper = form_data.get("any_unauthorized_persons_that_can_pick_up_camper")
      first_authorized_persons_name = form_data.get("first_authorized_persons_name")
      first_authorized_persons_phone = form_data.get("first_authorized_persons_phone")
      second_authorized_persons_name = form_data.get("second_authorized_persons_name")
      second_authorized_persons_phone = form_data.get("second_authorized_persons_phone")
      family_physician_NP_PA_name = form_data.get("family_physician_NP_PA_name")
      family_physician_NP_PA_phone_number = form_data.get("family_physician_NP_PA_phone_number")
      mental_healthcare_provider_name = form_data.get("mental_healthcare_provider_name")
      mental_healthcare_provider_phone_number = form_data.get("mental_healthcare_provider_phone_number")
      will_camper_take_medication_while_at_camp = form_data.get("will_camper_take_medication_while_at_camp")
      first_medication_name = form_data.get("first_medication_name")
      first_medication_dose = form_data.get("first_medication_dose")
      first_medication_times = form_data.get("first_medication_times")
      first_medication_reason_for_taking = form_data.get("first_medication_reason_for_taking")
      first_medication_prescriber_name = form_data.get("first_medication_prescriber_name")
      first_medication_prescriber_phone_number = form_data.get("first_medication_prescriber_phone_number")
      second_medication_name = form_data.get("second_medication_name")
      second_medication_dose = form_data.get("second_medication_dose")
      second_medication_times = form_data.get("second_medication_times")
      second_medication_reason_for_taking = form_data.get("second_medication_reason_for_taking")
      second_medication_prescriber_name = form_data.get("second_medication_prescriber_name")
      second_medication_prescriber_phone_number = form_data.get("second_medication_prescriber_phone_number")
      third_medication_name = form_data.get("third_medication_name")
      third_medication_dose = form_data.get("third_medication_dose")
      third_medication_times = form_data.get("third_medication_times")
      third_medication_reason_for_taking = form_data.get("third_medication_reason_for_taking")
      third_medication_prescriber_name = form_data.get("third_medication_prescriber_name")
      third_medication_prescriber_phone_number = form_data.get("third_medication_prescriber_phone_number")
      fourth_medication_name = form_data.get("fourth_medication_name")
      fourth_medication_dose = form_data.get("fourth_medication_dose")
      fourth_medication_times = form_data.get("fourth_medication_times")
      fourth_medication_reason_for_taking = form_data.get("fourth_medication_reason_for_taking")
      fourth_medication_prescriber_name = form_data.get("fourth_medication_prescriber_name")
      fourth_medication_prescriber_phone_number = form_data.get("fourth_medication_prescriber_phone_number")
      fifth_medication_name = form_data.get("fifth_medication_name")
      fifth_medication_dose = form_data.get("fifth_medication_dose")
      fifth_medication_times = form_data.get("fifth_medication_times")
      fifth_medication_reason_for_taking = form_data.get("fifth_medication_reason_for_taking")
      fifth_medication_prescriber_name = form_data.get("fifth_medication_prescriber_name")
      fifth_medication_prescriber_phone_number = form_data.get("fifth_medication_prescriber_phone_number")
      sixth_medication_name = form_data.get("sixth_medication_name")
      sixth_medication_dose = form_data.get("sixth_medication_dose")
      sixth_medication_times = form_data.get("sixth_medication_times")
      sixth_medication_reason_for_taking = form_data.get("sixth_medication_reason_for_taking")
      sixth_medication_prescriber_name = form_data.get("sixth_medication_prescriber_name")
      sixth_medication_prescriber_phone_number = form_data.get("sixth_medication_prescriber_phone_number")
      camper_dietary_preference_choices = form_data.get("camper_dietary_preference_choices")
      does_camper_have_any_food_allergies = form_data.get("does_camper_have_any_food_allergies")
      does_camper_have_any_drug_other_allergies = form_data.get("does_camper_have_any_drug_other_allergies")
      camper_physical_health_history_choices = form_data.get("camper_physical_health_history_choices")
      explain_any_other_unlisted_medical_history = form_data.get("explain_any_other_unlisted_medical_history")
      provide_explanation_of_any_checked_medical_history_items = form_data.get("provide_explanation_of_any_checked_medical_history_items")
      any_physical_activities_to_be_limited_or_restricted = form_data.get("any_physical_activities_to_be_limited_or_restricted")
      month_and_year_of_diphtheria_or_tetanus_immunization = form_data.get("month_and_year_of_diphtheria_or_tetanus_immunization")
      month_and_year_of_tetanus_booster_immunization = form_data.get("month_and_year_of_tetanus_booster_immunization")
      month_and_year_of_polio_immunization = form_data.get("month_and_year_of_polio_immunization")
      month_and_year_of_rotavirus_immunization = form_data.get("month_and_year_of_rotavirus_immunization")
      month_and_year_of_mumps_measles_or_rubella_immunization = form_data.get("month_and_year_of_mumps_measles_or_rubella_immunization")
      month_and_year_of_hepatitis_a_immunization = form_data.get("month_and_year_of_hepatitis_a_immunization")
      month_and_year_of_hepatitis_b_immunization = form_data.get("month_and_year_of_hepatitis_b_immunization")
      month_and_year_of_varicella_immunization = form_data.get("month_and_year_of_varicella_immunization")
      month_and_year_of_duration_of_chicken_pox = form_data.get("month_and_year_of_duration_of_chicken_pox")
      month_and_year_of_haemophilus_influenza_b_immunization = form_data.get("month_and_year_of_haemophilus_influenza_b_immunization")
      month_and_year_of_seasonal_flu_vaccine_immunization = form_data.get("month_and_year_of_seasonal_flu_vaccine_immunization")
      month_and_year_of_pneumococcal_vaccine_immunization = form_data.get("month_and_year_of_pneumococcal_vaccine_immunization")
      month_and_year_of_human_papillomavirus_immunization = form_data.get("month_and_year_of_human_papillomavirus_immunization")
      month_and_year_of_meningococcal_meningitis_immunization = form_data.get("month_and_year_of_meningococcal_meningitis_immunization")
      month_and_year_of_tuberculin_test = form_data.get("month_and_year_of_tuberculin_test")
      was_tuberculin_test_positive_or_negative = form_data.get("was_tuberculin_test_positive_or_negative")
      any_other_unlisted_immunizations = form_data.get("any_other_unlisted_immunizations")
      camper_mental_health_history_choices = form_data.get("camper_mental_health_history_choices")
      provide_explanation_for_any_checked_mental_illness_items = form_data.get("provide_explanation_for_any_checked_mental_illness_items")
      ...
      medicalinformation = MedicalInformation.objects.create(
        ...
        any_physical_activities_to_be_limited_or_restricted=any_physical_activities_to_be_limited_or_restricted,
