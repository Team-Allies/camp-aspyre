...
class Camper(models.Model):
    ...
    does_the_camper_have_any_disabilities = models.BooleanField(blank=True, null=True)
...
class Camp(models.Model):
    ...
    camp_start_date = models.DateField(null=True)
    camp_end_date = models.DateField(null=True)
    camp_location_street_address = models.CharField(max_length=255)
    camp_location_city = models.CharField(max_length=255)
...
# multiple choice field for all things inside the field; "all that apply"