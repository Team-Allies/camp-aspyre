...
class Camper(models.Model):
    ...
    have_disability = models.CharField(choices=DISABILITY_CHOICES, max_length=255)
    ...
    definite_transportation = models.CharField(choices=DEFINITE_TRANSPORTATION, max_length=50, default='No')
    SCHOLARSHIP_GRANTED = (
